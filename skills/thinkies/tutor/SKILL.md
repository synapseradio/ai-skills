...
- **Plan 3–5 layers**: each a complete, useful truth that grows more sophisticated rather than being replaced.
...
**Present one concept**: frame as collaborative discovery. Teach one thing at a time, concrete, with examples from the learner's domain. Past 2–3 paragraphs is too much at once.
