...
description: >-
  ...
  "help me understand what to ask", or to clarify a requirement or idea. Also
  use to judge when the better move is not a question at all — a restatement, a
  plain statement, silence, or asking nothing.
metadata:
  context: fork
---
