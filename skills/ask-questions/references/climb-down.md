...
Ask: Did that answer hand me a conclusion, belief, or plan rather than an observation?
If so, the work is downward, not forward.

## Instructions

1. **Don't argue with the conclusion.** Arguing meets them at the top of their ladder, where each of you defends a summary. Walk it down instead.
...
- What did they conclude, and what did they actually observe?
- What meaning got added between the observation and the conclusion, and at which step?
- Have we reached something we can both point to?
- Have I laid out the steps in my own thinking the same way I'm asking them to?

## Quality Criteria

When the climb down is doing its work:

- [ ] No conclusion was argued with at the top; each was walked down instead.
- [ ] The descent moved one rung at a time — added meaning named at each step.
- [ ] It ended at an observable both parties can inspect.
- [ ] Your own conclusions got the same treatment as theirs.
- [ ] Doubts about the inquiry's direction were routed to questioning the question, not to climbing down a claim.
