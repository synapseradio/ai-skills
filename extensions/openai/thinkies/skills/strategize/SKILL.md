...
Target: the problem in the current context; if none is evident, ask for clarification. Choose a descriptive working name (e.g. "api-architecture-exploration") so later turns can reference it. Tell the user: "Working on: [name]". Go to step 2.
